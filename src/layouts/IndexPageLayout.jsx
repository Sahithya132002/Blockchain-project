...
const IndexPageLayout = () => {
  return (
    ...
    >
      <div className="absolute bg-gradient-to-b from-blue-400 to-blue-400 opacity-75 inset-0 z-0"></div>
      <div className="min-h-screen flex flex-row mx-0 justify-center">
        <div className="hidden lg:flex flex-col self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10 text-white">
          <h1 className="mb-3 font-bold text-5xl">
            Welcome to our messaging application!
          </h1>
          <p className="pr-3 font-bold">
            Say goodbye to centralized servers and hello to secure, private
            chats. Our decentralized messaging app Crypto Talk requires no personal details
        ...
        <div className="flex justify-center self-center z-10">
          <div className="p-12 bg-white mx-auto rounded-2xl w-100 ">
            ...
            <div className="pt-5 text-center text-gray-400 text-xs">
              <span>
                Copyright © 2023FC12058
                <a
                  href="#"
                  rel=""
                  target="_blank"
                  title="2023FC12058"
                  className="text-blue hover:text-blue-500 ml-1"
                >
